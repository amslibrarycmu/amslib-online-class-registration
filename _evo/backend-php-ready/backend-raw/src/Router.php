            ...
            switch ($resource) {
                ...
                case 'admin':
                    if ($id === 'class-requests') {
                        ...
                        // For backwards compatibility or future additions
                        $this->notFound();
                    } else {
                        $this->notFound();
                    }
                ...
                case 'users':
                    ...
                    if ($method === 'GET' && $id === 'me') {
                        ...
                        $controller->updateAdminLevel($subResource); // parts: api, users, admins, {id}, level
                        ...
                        $controller->uploadPhoto(); // Note: POST since it's multipart/form-data

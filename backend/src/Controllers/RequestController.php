...
class RequestController extends BaseController {
    ...
    public function adminIndex() {
        ...
        $sql = "
            ...
            (SELECT user_name FROM activity_logs WHERE target_type = 'REQUEST' AND target_id = cr.request_id AND action_type IN ('APPROVE_CLASS_REQUEST', 'REJECT_CLASS_REQUEST') ORDER BY created_at DESC LIMIT 1) as action_by_name,
            (SELECT user_id FROM activity_logs WHERE target_type = 'REQUEST' AND target_id = cr.request_id AND action_type IN ('APPROVE_CLASS_REQUEST', 'REJECT_CLASS_REQUEST') ORDER BY created_at DESC LIMIT 1) as action_by_id

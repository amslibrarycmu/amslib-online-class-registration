        ...
        <div className="p-6 overflow-y-auto flex-grow text-gray-700 leading-relaxed text-sm md:text-base space-y-4">
          ...
          <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>เพื่อวิเคราะห์และนำไปพัฒนาปรับปรุงการให้บริการของห้องสมุดคณะเทคนิคการแพทย์</li>
          ...
          <div className="bg-gray-100 p-4 rounded-lg border-l-4 border-gray-400 text-sm italic">
            <strong>หมายเหตุ:</strong> การกดยอมรับเพื่อดำเนินการต่อหรือการเข้าร่วมนี้ ถือว่าท่านได้อ่านและให้ความยินยอมแก่ห้องสมุดคณะเทคนิคการแพทย์ในการเก็บรวบรวม ใช้ และเปิดเผยข้อมูลส่วนบุคคลของท่าน ตามวัตถุประสงค์ที่ได้ระบุไว้ข้างต้นทุกประการ
          </div>
        </div>
